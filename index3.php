...
// echo "&nbsp<br/><br/><br/><br/><br/><br/><br/>";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="online-man">
  <ul>
    ...
    <div class="mes_fixed_big">
      <div class="mes_abs">
        ...
        <div class="mes_con" style="display: none;">
            ...
            <!-- 消息列表 -->
            <div class="mes_box">
                <span class='mex_con'>eeeeeee</span>
    ...
    <form action="" >
    	<div>这是提交表单</div>
    	<input type="submit" value="提交" id="from_act">
    </form>
    <div style="text-align: center;font-family: 'Microsoft YaHei', SimSun, sans-serif;">当前在线<span class='online_ren'></span>人</div>
 <script type="text/javascript">
 $(function(){
 	$('#from_act').click(function (){
 		onAudit(to_uid, '审核', uid, oms_id, '你有一条审核消息！', '<?php echo DOCUMENT_URL;?>/onAudit.php');
 		// return false;
 	})
 	  //小人初始化
 	 //选择人
...
<form onsubmit="onSubmit(); return false;"></form>
<div id="man"></div>
</body>
</html>