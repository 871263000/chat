...
<!--                      <div class='onload'  style='text-align: center;'><span style='color: #fff;padding: 5px 0;'>---查看更多---</span></div>-->
              ...
              <div class="plus_menu_box">
                <div class="plus_menu">
                  <span class="header_icon plus-list"><img src="images/header_icon.png" alt=""></span><span class="plus-list"><img src="images/uploadimg1.png" alt=""></span>
                </div>
...
<!-- img放大 -->
<div class="send-img-box"><span class="send-img-close">&times;</span></div>
<!-- 弹出框 -->
...
$('.he_ov .send-img').live( 'click', function (){
  ...
  $('.send-img-box').show();
  $('.send-img-box').append($(this).clone());
...
$('.send-img-close, .send-img-box').click( function (){
    $('.send-img-box').hide();
})
  //组织架构的引用
   // console.log(sidList)
