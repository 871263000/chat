if (typeof console == "undefined") {    this.console = { log: function (msg) {  } };}
    ...
    function onmessage(e)
    {
        ...
        switch(data['type']){
            ...
            case 'mes_notice_close':
              ...
              break;
            case 'mesClose':
            //消息的关闭 @param data.CloseUid 要关闭的uid
                mesClose(data.CloseUid);
              // console.log(data);
              break;
            case 'logout':
    ...
    //消息的关闭
    function mesClose( session_id ){
      var session_id = parseInt(chat_uid) < parseInt( session_id ) ? chat_uid+"-"+session_id : session_id+"-"+chat_uid;
      var CloseNum = $('.mes_chakan_close[session_no="'+session_id+'"]').attr('chat_mes_num');
      if ( CloseNum != undefined ) {
        mesnum = mesnum - parseInt(CloseNum);
