...
<head>
	...
	@font-face {
	  ...
	  src: url('//at.alicdn.com/t/font_1458138100_1956043.eot'); /* IE9*/
	  src: url('//at.alicdn.com/t/font_1458138100_1956043.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  url('//at.alicdn.com/t/font_1458138100_1956043.woff') format('woff'), /* chrome、firefox */
	  url('//at.alicdn.com/t/font_1458138100_1956043.ttf') format('truetype'), /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
	  url('//at.alicdn.com/t/font_1458138100_1956043.svg#iconfont') format('svg'); /* iOS 4.1- */
	}
                    
    .staff-refresh, .staff-close, .chat_chain{
	...
	<table class="table table-bordered table-striped">
		<tr>
			...
			<div></div>
				...
				<span class= "customer_followed"></span><span style ="margin-left: 10px;vertical-align: 3px;"><?php echo $arrNewFollow[$customer['followStatus']]; ?></span>
...
$('.customer_followed').click(function () {
	if ( customerStatu == 0 ) {
		$.ajax({
			url: "ajaxOms_company_follow.php",
			type: :"post",
			data: "",
			success: function () {
