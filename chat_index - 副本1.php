...
$(document).on(mousewheelevt,".online_man",function (event){
    ...
    console.log(onlinesSroll);
    console.log(onlineScrollHeight);
    console.log(hideOnlineHeightPro);
    console.log(onlineScrollHeight + onlinesSroll);
    if(wheeldir > 0 && onlineTop+onlineHeight > docuHeight ){
      onlinesSroll += onlineScrollHeight * ( 47/hideOnlineHeightPro );
      if (47/hideOnlineHeightPro > 1) {
          onlinesSroll = onlineScrollHeight + onlineTop;
      };
        onlineTop -=47;
        ;
...
//删除最近联系人
var delContactFun = function( id, mestype ){
...
$('.chat_people').live('click', function( e ){
  ...
  //end
    ...
    delContactFun( delconid, mes_type );
